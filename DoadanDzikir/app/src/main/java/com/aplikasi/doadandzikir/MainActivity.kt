...
class MainActivity : AppCompatActivity() {
    ...
    private val listArtikel: ArrayList<Artikel1> = arrayListOf()
    ...
    private fun initView() {
        ...
        val llDzikirDoaDanHarian: LinearLayout = findViewById(R.id.ll_dzikir_dan_doa_harian)
