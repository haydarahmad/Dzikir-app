...
import com.aplikasi.doadandzikir.DzikirDoa as DzikirDoa1
...
object DataDzikirDoa {
    ...
    val listQauliyah: ArrayList<DzikirDoa1>
        get() {
            val list = arrayListOf<DzikirDoa1>()
            for (data in descQauliyah.indices){
                val qauliyah = DzikirDoa1(
                    descQauliyah[data],
                    lafazQauliyah[data],
    ...
    val listDzikir: ArrayList<DzikirDoa1>
        get() {
            val list = arrayListOf<DzikirDoa1>()
            for (data in descDzikir.indices) {
                val dzikir = DzikirDoa1(
                    descDzikir[data],
                    lafazDzikir[data],
                    terjemahDzikir[data]
                )
    ...
    val listDzikirPagi : ArrayList<DzikirDoa1>
        get() {
            val list = arrayListOf<DzikirDoa1>()
    ...
    val listDzikirPetang : ArrayList<DzikirDoa1>
        get() {
            val list = arrayListOf<DzikirDoa1>()
